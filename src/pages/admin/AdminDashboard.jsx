...
  const { policies, getDashboardData, isAuthReady } = usePolicy(); // Added isAuthReady to ensure data is loaded

  // Only attempt to get dashboard data if auth and policies are ready
  const dashboardData = isAuthReady && policies.length > 0 ? getDashboardData() : {
    activePolicies: 0,
    totalRevenue: 0,
    expiringSoon: 0,
    recentPolicies: [],
...
              12% from last month {/* This is static, keep as-is for now */}
            </p>
          </div>
...
            <p className="text-green-600 flex items-center text-sm">
              <ArrowUp className="h-4 w-4 mr-1" />
              8% from last month {/* This is static, keep as-is for now */}
            </p>
          </div>
...
                        {policy.createdAt ? format(policy.createdAt, 'dd/MM/yyyy') : 'N/A'}
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap">
